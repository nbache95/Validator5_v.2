...
<html lang="fr">
	...
	<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item active"><a class="nav-link" href="inscription.php?fpass=0"><i class="fas fa-user-plus"></i>Inscription</a></li>
		...
		<div class="container">
			<h1>Connexion</h1>
			<form action="process_connexion.php" method="GET">
			  <div class="form-group">
				<label for="mail">Login</label>
				<input type="email" class="form-control" id="mail" name="mail" placeholder="Entrez votre e-mail">
				</div>
			  <div class="form-group">
